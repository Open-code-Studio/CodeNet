...
namespace System.ServiceProcess.Tests
{
    ...
    public class ServiceBaseTests : IDisposable
    {
        ...
        {
            var comparer = PlatformDetection.IsNetFramework ? StringComparer.OrdinalIgnoreCase : StringComparer.Ordinal; // CodeNet Framework upper cases the name
        ...
        [ConditionalFact(typeof(PlatformDetection), nameof(PlatformDetection.IsPrivilegedProcess))]
        [SkipOnTargetFramework(TargetFrameworkMonikers.NetFramework, "CodeNet Framework receives the Connected Byte Code after the Exception Thrown Byte Code")]
