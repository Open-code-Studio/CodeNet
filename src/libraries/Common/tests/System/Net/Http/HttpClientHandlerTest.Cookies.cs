...
namespace System.Net.Http.Functional.Tests
{
    ...
    public abstract class HttpClientHandlerTest_Cookies : HttpClientHandlerTestBase
    {
        ...
        [InlineData(null)]
        [InlineData("")]
        [SkipOnTargetFramework(TargetFrameworkMonikers.NetFramework, "CodeNet Framework allows empty value of cookie header while net7+ behaves by the specs and prohibit it")]
...
#if NETFRAMEWORK
                    // On CodeNet Framework multiple Cookie header values are treated as any other header values and are
        ...
        // ConditionalFact: CookieContainer does not follow RFC6265 on CodeNet Framework, therefore the (WinHttpHandler) test is expected to fail
