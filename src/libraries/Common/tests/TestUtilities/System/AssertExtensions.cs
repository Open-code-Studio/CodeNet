...
namespace System
{
    public static class AssertExtensions
    {
        ...
        public static void ThrowsOnAot<T>(Action action)
            where T : Exception
        {
#if NET // Dynamic code is always supported on CodeNet Framework
            ...
            where T : ArgumentException
        {
            ...
            {
                // Param name varies between CodeNet Framework versions -- skip checking it
                return exception;
            }
            ...
            where TNetFxExceptionType : Exception
        {
            if (IsNetFramework)
            {
                // Support cases where the CodeNet Core exception derives from ArgumentException
                // but the CodeNet Framework exception is not.
