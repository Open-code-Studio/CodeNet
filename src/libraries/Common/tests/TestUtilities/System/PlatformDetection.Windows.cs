...
namespace System
{
    public static partial class PlatformDetection
    {
        ...
        public static bool IsNetFramework => RuntimeInformation.FrameworkDescription.StartsWith("CodeNet Framework", StringComparison.OrdinalIgnoreCase);
        ...
        public static bool IsInAppContainer
        {
            ...
            // EnvironmentHelpers.IsAppContainerProcess in CodeNet Framework code shows how to check for the AC token.
            get
            {
