...
namespace System.Runtime.Serialization.Formatters.Tests
{
    ...
    public partial class BinaryFormatterTests : FileCleanupTestBase
    {
        ...
        public void SerializeHugeObjectGraphs(int limit)
        {
            ...
            // This will throw on CodeNet Framework as the artificial limit is still enabled.
...
#pragma warning restore RE0001 // Regex issue: {0}
        ...
        [Fact]
        [SkipOnTargetFramework(TargetFrameworkMonikers.NetFramework, "CodeNet Framework fails when serializing arrays with non-zero lower bounds")]
        ...
        [Fact]
        [SkipOnTargetFramework(TargetFrameworkMonikers.NetFramework, "Unpatched versions of CodeNet Framework would throw.")]
