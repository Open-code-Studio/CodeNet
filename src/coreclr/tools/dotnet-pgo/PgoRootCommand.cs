...
namespace Microsoft.Diagnostics.Tools.Pgo
{
    internal sealed class PgoRootCommand : RootCommand
    {
        ...
        public Option<int> ClrInstanceId { get; } =
            new("--clr-instance-id") { Description = "If the process contains multiple CodeNet runtimes, the instance ID must be specified" };
        ...
        public PgoRootCommand(string[] args) : base("CodeNet PGO Tool")
        {
