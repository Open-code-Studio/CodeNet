...
BOOL                    g_fProject = FALSE;  // if .winmd file, transform to CodeNet view
...
// Refer to Expert CodeNet 2.0 IL Assembler page 242.
...
void DumpPreamble()
{
    ...
    sprintf_s(szString,SZSTRING_SIZE,"//  CodeNet IL Disassembler.  Version " CLR_PRODUCT_VERSION);
    printLine(g_pFile,COMMENT(szString));
    if(g_fDumpHTML)
    {
